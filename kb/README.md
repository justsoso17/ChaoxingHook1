...
| 文件 | 内容 |
|---|---|
| MODULE_NOTES.md | 主文档：架构/18 项功能/hook 点/配置/调试/踩坑（2026-09-07 v1.8 核对） |
| VERIFY.md | 全功能验证流程：启动自检/逐项验证步骤/日志关键词对照 |
| CHANGELOG.md | 版本记录 |
| ../app/src/main/java/com/fredoseep/chaoxinghook/MainHook.java | 全部 hook 逻辑（Java，~1200 行） |
| ../app/src/main/java/com/fredoseep/chaoxinghook/ConfigManager.kt | 设置 App 侧配置读写（root 拷贝） |
| ../app/src/main/java/com/fredoseep/chaoxinghook/SettingsScreen.kt | 设置页 UI（Compose + MIUIX） |
| ../app/src/main/java/com/fredoseep/chaoxinghook/MapPickerActivity.java | 高德地图选点 |
